...
- 下一颗水果随机为🍒/🍓/🍇/🍊之一；🍉只能由合并产生
- 落果有短暂冷却且需全场接近静止，避免连点穿透；最高分记录在本地浏览器；通关可生成纪念卡并可上排行榜`,
    en: `## How to play
...
- Drops have a short cooldown and require the field to be nearly at rest to prevent clip-through; best score stored locally; clearing a run generates a memorial card and may enter the leaderboard`,
  },
